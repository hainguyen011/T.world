namespace T.world
{
    partial class Register
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.register_form.Controls.Add(this.label2);
            this.register_form.Controls.Add(this.txtAddress);
            this.register_form.Controls.Add(this.txtPass);
            this.register_form.Controls.Add(this.txtPhone);
            this.register_form.Controls.Add(this.txtEmail);
            this.register_form.Controls.Add(this.txtLName);
            this.register_form.Controls.Add(this.label1);
            this.register_form.Controls.Add(this.txtFName);
